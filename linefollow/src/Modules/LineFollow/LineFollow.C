...
/*! This module is provided as an example of how to create a new standalone module.
    ...
    @videomapping YUYV 640 480 28.7 YUYV 640 480 28.7 mm6567 LineFollow
    ...
    @restrictions None */
class LineFollow : public jevois::Module
{
  public:
    ...
    virtual void process(jevois::InputFrame && inframe, jevois::OutputFrame && outframe) override
    {
      ...
      jevois::rawimage::writeText(outimg, "Hello JeVois mm6567 LineFollow", 100, 230, jevois::yuyv::White, jevois::rawimage::Font20x38);
...
JEVOIS_REGISTER_MODULE(LineFollow);
